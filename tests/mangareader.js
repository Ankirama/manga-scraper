...
describe('MangaReader', function() {
    ...
    describe('Check package', function() {
        ...
        it('should have apikey empty', function() {
            expect(mangareader.apikey).to.be.empty;
        });
        it('should set an apikey', function() {
            mangareader.setAPIKey(apikey);
            expect(mangareader.apikey).to.equal(apikey);
        });
    });
    describe('Check calls to pseudo-api', function() {
        before(function() {
            if (mangareader.apikey.length === 0) {
                mangareader.setAPIKey(apikey);
            }
        ...
        before(function() {
            return new Promise(function(resolve) {
                    return mangareader.getGenreList()
                        .then(function(data) {
                            return resolve(data);
                        })
                        .catch(function(err) {
        ...
        before(function() {
            return new Promise(function(resolve) {
                    return mangareader.getMangaByGenre(genre)
                        .then(function(data) {
                            return resolve(data);
                        })
                        .catch(function(err) {
        ...
        describe('#getMangaByGenre KO', function() {
            it('should return {} if a genre is wrong', function(done) {
                mangareader.getMangaByGenre(badGenre)
                    .then(function(data) {
        ...
        before(function() {
            return new Promise(function(resolve) {
                    return mangareader.getManga(manga)
                        .then(resolve)
                        .catch(function(err) {
                            resolve(null);
                        });
        ...
        before(function() {
            return new Promise(function(resolve) {
                    return mangareader.getChapter(manga, chapter)
                        .then(resolve)
                        .catch(function(err) {
                            return resolve(null);
                        });
        ...
        before(function() {
            return new Promise(function(resolve) {
                    return mangareader.search(searchQueryOK)
                        .then(resolve)
                        .catch(function(err) {
                            return resolve(null);
                        });
        ...
        describe('#search KO', function() {
            it('should return an empty object', function(done) {
                mangareader.search(searchQueryKO)
                    .then(function(data) {
                        expect(data).to.be.an('object').that.is.deep.equal({});
                        done();
                    })
